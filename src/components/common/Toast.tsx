        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className={`pointer-events-auto flex items-center gap-4 px-6 py-5 rounded-[2rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15)] border bg-white ${
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                <span className={`text-[10px] font-black capitalize tracking-[0.2em] ${
              ...
              <button 
                ...
                className="ml-auto p-1.5 hover:bg-slate-50 rounded-xl text-slate-300 hover:text-slate-900 transition-all"
              >
