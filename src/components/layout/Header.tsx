...
const Header = () => {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 relative">
      <div className="text-xl font-bold text-gray-800">System Performance Monitor</div>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {isOpen && (
          <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-gray-200 shadow-lg rounded-lg z-[1000] py-2">
            <button 
