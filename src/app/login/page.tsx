...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-slate-950 relative overflow-hidden">
      ...
      >
        <div className="bg-white p-10 sm:p-12 rounded-[2rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] flex flex-col border border-slate-100">
          {/* Header */}
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-100 pl-14 pr-6 py-4 rounded-xl text-xs font-bold focus:bg-white focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 outline-none transition-all shadow-inner"
                  required
                />
              </div>
            </div>
