      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <Link key={item.title} href={item.href} className="modern-card p-8 flex flex-col gap-5 group">
            ...
            <div className="flex items-center gap-1.5 text-xs font-black text-blue-600 capitalize tracking-widest mt-auto opacity-0 group-hover:opacity-100 transition-all translate-x-[-10px] group-hover:translate-x-0">
          ...
          {hostGroups?.map((g: any) => {
            ...
            return (
              <button
                ...
                className={`px-6 py-2.5 rounded-xl text-xs font-black capitalize tracking-widest transition-all duration-300 border ${
                  isActive 
