    ...
    <Block title="Memory Performance Metrics" subtitle="Daily Memory Utilization Analysis" tabs={[]}>
      ...
      <div className="flex justify-between items-center mb-6 px-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-black text-slate-400 capitalize tracking-widest">{isFetching ? 'Stream Incoming' : response?.data ? 'Data Link Online' : 'System Ready'}</span>
        </div>
