  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8">
      <header className="mb-20 text-center">
        ...
        <h1 className="text-5xl text-slate-900 capitalize italic tracking-tight mb-4">Explorer DB Guide</h1>
        <p className="text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed">Technical reference for querying performance metrics and managing database maintenance operations.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <Section title="1. Querying Data" icon={<Search size={16} className="text-purple-500" />}>
          <div className="modern-card p-8 h-full">
            <h4 className="text-slate-900 mb-6 flex items-center gap-2 capitalize italic tracking-tight"><Database size={18} className="text-purple-600" /> Interactive Query Workflow</h4>
        ...
        <Section title="2. Maintenance" icon={<Trash2 size={16} className="text-red-500" />}>
          <div className="modern-card p-8 h-full">
            <h4 className="text-slate-900 mb-6 flex items-center gap-2 capitalize italic tracking-tight"><Trash2 size={18} className="text-red-600" /> Data Deletion & Purging</h4>
            ...
            <div className="space-y-4">
              <h5 className="text-slate-400 capitalize  text-[9px]">Methods</h5>
      ...
      <Section title="4. Parameter Reference">
        <div className="modern-card overflow-hidden">
          <table className="w-full text-left">
            <thead className="bg-slate-50/80 border-b border-slate-100 text-slate-500 capitalize text-xs">
              <tr>
            ...
            <tbody className="divide-y divide-slate-50 text-slate-600">
              {[
                ...
                <tr key={row.p} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-8 py-5 text-slate-900 font-mono text-xs">{row.f}</td>
                  <td className="px-8 py-5 text-right text-[11px] font-bold text-slate-500">{row.d}</td>
                </tr>
              ))}
            </tbody>
          </table>
