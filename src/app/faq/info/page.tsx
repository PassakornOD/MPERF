...
const Section = ({ title, children, icon }: { title: string, children: React.ReactNode, icon?: React.ReactNode }) => (
  <section className="mb-16">
    <h3 className="text-xl font-bold text-slate-400 capitalize  mb-8 flex items-center gap-2">
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 animate-ease-in pb-32">
      <header className="mb-24 text-center">
        ...
        <h1 className="text-6xl text-slate-900 tracking-tight mb-6 capitalize italic">Docker Runtime Guide</h1>
          ...
          <div className="space-y-10">
            <div className="relative group">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-slate-500 capitalize text-xs"># 01. Build production image set</p>
              </div>
            ...
            <div className="relative group">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-2 h-2 rounded-full bg-slate-700"></div>
                <p className="text-slate-500 capitalize  text-xs"># 02. Deploy services via Compose</p>
              </div>
