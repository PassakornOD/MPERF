...
const Section = ({ title, children, icon: Icon }: { title: string, children: React.ReactNode, icon?: React.ElementType }) => (
    <section className="mb-16">
        <h3 className="text-muted-foreground capitalize text-xl mb-8 flex items-center gap-3">
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-20 animate-ease-in pb-32">
            <header className="mb-20 text-center space-y-6">
                ...
                <h1 className="text-5xl text-foreground tracking-tight capitalize italic">Operations Guide</h1>
                <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto leading-relaxed font-medium">Manage your server assets, analyze performance, and generate comprehensive reports.</p>
            </header>

            {/* 1. Manage Assets */}
            <Section title="Manage Assets" icon={Package}>
                <div className="modern-card p-8 sm:p-10">
                    <h4 className="text-lg text-foreground mb-6 flex items-center gap-3 capitalize tracking-tight"><Server size={24} className="text-blue-600" /> Hostgroup & Hostname Management</h4>
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    <li key={i} className="flex gap-3">
                                        ...
                                        <div className="text-sm text-muted-foreground"><b>{item.label}:</b> {item.desc}</div>
                                    </li>
                                ))}
                            </ul>
                        </div>
                        <div className="bg-background/50 p-8 rounded-[2rem] border border-border flex flex-col justify-center shadow-inner">
                            <p className="text-muted-foreground capitalize  text-[9px] mb-4">Quick Access Path</p>
                            <p className="text-base text-foreground mb-3 capitalize italic tracking-tight">Navigate to:</p>
                            <div className="bg-card p-4 rounded-xl border border-border text-xs text-blue-600 flex items-center gap-2 shadow-sm">
            ...
            <Section title="Performance Analysis" icon={Activity}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="modern-card p-8 sm:p-10 transition-all group">
                        ...
                        <h4 className="text-xl text-foreground mb-4 capitalize italic tracking-tight">Sarlog</h4>
                    ...
                    <div className="modern-card p-8 sm:p-10 transition-all group">
                        ...
                        <h4 className="text-xl text-foreground mb-4 capitalize italic tracking-tight">Utilization</h4>
            ...
            <Section title="Automated Performance Reporting" icon={FileText}>
                <div className="modern-card p-8 sm:p-10 space-y-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h4 className="text-lg text-foreground capitalize italic tracking-tight">Generate Report (Manual)</h4>
                            </div>
                            <p className="text-sm text-muted-foreground font-medium">Ad-hoc report generation for specific timeframes or host selection.</p>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h4 className="text-lg text-foreground capitalize italic tracking-tight">Batch Report (Automated)</h4>
                            </div>
                            <p className="text-sm text-muted-foreground font-medium">Recurring, large-scale reports based on pre-configured templates.</p>
                            <ol className="space-y-3">
                                {[
                    ...
                    <div className="pt-10 border-t border-slate-50">
                        <h4 className="text-xl text-foreground mb-8 flex items-center gap-3 capitalize italic tracking-tight"><Layout size={24} className="text-indigo-600" /> Creating Report Templates</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={idx} className="bg-indigo-50/50 p-6 rounded-[1.5rem] border border-indigo-100 flex flex-col justify-between group hover:bg-indigo-600 transition-all duration-300 shadow-inner">
                                    <div className="text-muted-foreground capitalize  text-[9px] mb-4 group-hover:text-indigo-200">Step 0{idx + 1}</div>
                                    <div>
                    ...
                    {/* Technical Deep Dive */}
                    <div className="pt-10 border-t border-slate-50">
                        <h4 className="text-xl text-foreground mb-8 capitalize italic tracking-tight">Execution & Automation</h4>
                        <div className="bg-slate-900 p-8 rounded-[2rem] text-slate-300 font-mono text-[11px] shadow-2xl overflow-hidden relative border border-slate-800">
                            ...
                            <div className="relative z-10 space-y-6">
                                <div className="space-y-3">
                                    <p className="text-muted-foreground capitalize  text-[9px] flex items-center justify-between">
