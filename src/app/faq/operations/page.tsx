        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-20 animate-ease-in pb-32">
            ...
            <Section title="Manage Assets" icon={Package}>
                <div className="modern-card p-8 sm:p-10">
                    <h4 className="text-xl font-black text-slate-900 mb-6 flex items-center gap-3 capitalize italic tracking-tight"><Server size={24} className="text-blue-600" /> Hostgroup & Hostname Management</h4>
            ...
            <Section title="Automated Performance Reporting" icon={FileText}>
                <div className="modern-card p-8 sm:p-10 space-y-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h4 className="text-lg font-black text-slate-900 capitalize italic tracking-tight">Generate Report (Manual)</h4>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h4 className="text-lg font-black text-slate-900 capitalize italic tracking-tight">Batch Report (Automated)</h4>
                            </div>
                    ...
                    <div className="pt-10 border-t border-slate-50">
                        <h4 className="text-xl font-black text-slate-900 mb-8 flex items-center gap-3 capitalize italic tracking-tight"><Layout size={24} className="text-indigo-600" /> Creating Report Templates</h4>
                    ...
                    {/* Technical Deep Dive */}
                    <div className="pt-10 border-t border-slate-50">
                        <h4 className="text-xl font-black text-slate-900 mb-8 capitalize italic tracking-tight">Execution & Automation</h4>
