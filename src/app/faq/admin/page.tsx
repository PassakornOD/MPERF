        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm p-8 flex flex-col gap-4">
                ...
                <div className="pt-4 border-t border-gray-100 space-y-3">
                    <div>
                        <span className="text-[10px] font-black text-blue-600 uppercase">Workflow</span>
                    ...
                    <div className="p-3 bg-red-50 rounded-lg text-[10px] font-bold text-red-700">Security: Protected accounts (sysreport/mfadmin) are locked.</div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm p-8 flex flex-col gap-4">
                ...
                <div className="pt-4 border-t border-gray-100 space-y-3">
                    <div>
                        <span className="text-[10px] font-black text-green-600 uppercase">Workflow</span>
                        <ul className="text-[11px] text-gray-600 mt-1 list-disc pl-4 space-y-0.5">
                            <li>Create group via "+" icon.</li>
                            <li>Edit to add members & PG associations.</li>
                        </ul>
                    </div>
                    <div className="p-3 bg-amber-50 rounded-lg text-[10px] font-bold text-amber-800">Note: Default system groups (admin, sysadmin) are protected.</div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm p-8 flex flex-col gap-4">
                ...
                <div className="pt-4 border-t border-gray-100 space-y-3">
                    <div>
                        <span className="text-[10px] font-black text-purple-600 uppercase">Workflow</span>
                        <ul className="text-[11px] text-gray-600 mt-1 list-disc pl-4 space-y-0.5">
                    ...
                    <div className="p-3 bg-purple-50 rounded-lg text-[10px] font-bold text-purple-800">Security: Access is restricted by created_by or user ownership.</div>
                </div>
            </div>
        </div>
      </Section>
      ...
      <Section title="3. Security & Best Practices" icon={<Lock size={16} className="text-red-500"/>}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-amber-50 border border-amber-200 rounded-[32px] p-8">
                  <h4 className="font-black text-amber-900 text-xs uppercase tracking-tight mb-4 flex items-center gap-2"><Lock size={16}/> Best Practices</h4>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-[32px] p-8">
                  <h4 className="font-black text-white text-xs uppercase tracking-tight mb-4 flex items-center gap-2"><AlertTriangle size={16}/> System Integrity</h4>
