      ...
      <Section title="1. Admin Modules" icon={<ShieldCheck size={16} className="text-blue-500"/>}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="modern-card p-8 flex flex-col gap-4">
                ...
                <h4 className="font-black text-slate-900 text-sm capitalize italic tracking-tight">User Management</h4>
            ...
            <div className="modern-card p-8 flex flex-col gap-4">
                ...
                <h4 className="font-black text-slate-900 text-sm capitalize italic tracking-tight">User Group Management</h4>
            ...
            <div className="modern-card p-8 flex flex-col gap-4">
                ...
                <h4 className="font-black text-slate-900 text-sm capitalize italic tracking-tight">Permission Management</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
                ...
                <div key={idx} className="modern-card p-8 flex flex-col items-center text-center">
                    <div className="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 font-black text-xs mb-4">0{idx + 1}</div>
                    <h4 className="font-black text-slate-900 text-sm mb-3 capitalize italic tracking-tight">{card.title}</h4>
      ...
      <Section title="3. Security & Best Practices" icon={<Lock size={16} className="text-red-500"/>}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-amber-50 border border-amber-200 rounded-[2rem] p-8 shadow-sm">
                  <h4 className="font-black text-amber-900 text-xs capitalize italic tracking-tight mb-4 flex items-center gap-2"><Lock size={16}/> Best Practices</h4>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-[2rem] p-8 shadow-2xl">
                  <h4 className="font-black text-white text-xs capitalize italic tracking-tight mb-4 flex items-center gap-2"><AlertTriangle size={16}/> System Integrity</h4>
