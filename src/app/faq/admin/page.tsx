    ...
    return (
        <div className="max-w-5xl mx-auto px-6 py-16">
            <header className="mb-20 text-center">
                ...
                <h1 className="text-5xl text-foreground capitalize italic tracking-tight mb-4">Admin Dashboard Guide</h1>
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">Centralized management for system access, user roles, and security configurations.</p>
            </header>
            ...
            <Section title="1. Admin Modules" icon={<ShieldCheck size={16} className="text-blue-500" />}>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="modern-card p-8 flex flex-col gap-4">
                        ...
                        <h4 className="text-foreground text-sm capitalize italic tracking-tight">User Management</h4>
                        <p className="text-[11px] text-muted-foreground leading-relaxed flex-grow">Manage user lifecycle. Administrators can create, modify, and delete users.</p>
                        <div className="pt-4 border-t border-border space-y-3">
                            <div>
                                <span className="text-muted-foreground capitalize  text-[9px]">Workflow</span>
                    ...
                    <div className="modern-card p-8 flex flex-col gap-4">
                        ...
                        <h4 className="text-foreground text-sm capitalize italic tracking-tight">User Group Management</h4>
                        <p className="text-[11px] text-muted-foreground leading-relaxed flex-grow">Organize users into logical groups for efficient permission application.</p>
                        <div className="pt-4 border-t border-border space-y-3">
                            <div>
                                <span className="text-muted-foreground capitalize  text-[9px]">Workflow</span>
                                <ul className="text-[11px] text-slate-600 mt-1 list-disc pl-4 space-y-0.5">
                    ...
                    <div className="modern-card p-8 flex flex-col gap-4">
                        ...
                        <h4 className="text-foreground text-sm capitalize italic tracking-tight">Permission Management</h4>
                        <p className="text-[11px] text-muted-foreground leading-relaxed flex-grow">Granular mapping of security permissions to specific Hostgroups.</p>
                        <div className="pt-4 border-t border-border space-y-3">
                            <div>
                                <span className="text-muted-foreground capitalize  text-[9px]">Workflow</span>
                                <ul className="text-[11px] text-slate-600 mt-1 list-disc pl-4 space-y-0.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={idx} className="modern-card p-8 flex flex-col items-center text-center">
                            ...
                            <h4 className="text-foreground text-sm mb-3 capitalize italic tracking-tight">{card.title}</h4>
                            <p className="text-muted-foreground text-[11px] leading-relaxed font-medium">{card.desc}</p>
                        </div>
                    ))}
                </div>
            </Section>
            ...
            <Section title="3. Security & Best Practices" icon={<Lock size={16} className="text-red-500" />}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-[2rem] p-8 shadow-2xl">
                        ...
                        <ul className="space-y-3 text-xs text-muted-foreground font-bold capitalize tracking-tight">
