...
const InventoryManageNamesPage = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <h2 className="text-xl font-black text-gray-800">Manage Hostnames</h2>
      {canCreate && (
            ...
            <table className="w-full text-xs text-left">
              <thead className="bg-gray-50 text-gray-600 uppercase font-bold sticky top-0">
                <tr>
                  ...
                  {canUpdate && <th className="px-4 py-3 text-right sticky right-0 bg-gray-50 shadow-[-4px_0_10px_-4px_rgba(0,0,0,0.1)]">Actions</th>}
                </tr>
              </thead>
                        ...
                        <td className="px-4 py-3 text-right space-x-2 sticky right-0 bg-white group-hover:bg-blue-50/30 shadow-[-4px_0_10px_-4px_rgba(0,0,0,0.1)]">
                            {editingName?.hostname_id === h.hostname_id ? (
                                ...
                                <div className="flex gap-2 justify-end">
                                    ...
                                    {canDelete && <button onClick={() => window.confirm('Delete this host?') && deleteNameMutation.mutate(h.hostname_id)} className="text-red-600 hover:text-red-800 p-1 rounded-md hover:bg-red-50"><Trash2 className="w-4 h-4" /></button>}
                                </div>
                            )}
                        </td>
                    )}
...
export default InventoryManageNamesPage;
