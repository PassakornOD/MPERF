        ...
        <div className="modern-card p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 items-end">
            <div className="space-y-2 lg:col-span-1">
                <label className="text-xs font-black text-slate-400 capitalize tracking-widest ml-1">Database Table</label>
                <input 
            ...
            <div className="space-y-2">
                <label className="text-xs font-black text-slate-400 capitalize tracking-widest ml-1">Year</label>
                <input 
                  placeholder="YYYY"
            ...
            <div className="space-y-2">
                <label className="text-xs font-black text-slate-400 capitalize tracking-widest ml-1">Month</label>
                <input 
                  placeholder="MM"
                  className="w-full bg-slate-50 border border-slate-100 rounded-xl py-3 px-4 text-xs font-black outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 transition-all shadow-inner"
            ...
            <div className="space-y-2">
                <label className="text-xs font-black text-slate-400 capitalize tracking-widest ml-1">Day</label>
                <input 
                  placeholder="DD"
                  className="w-full bg-slate-50 border border-slate-100 rounded-xl py-3 px-4 text-xs font-black outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 transition-all shadow-inner"
                  value={formData.day}
            ...
            <button 
              onClick={handleQuery}
              className="bg-slate-900 hover:bg-black text-white rounded-xl px-8 py-3.5 text-xs font-black capitalize tracking-[0.2em] flex items-center justify-center gap-2.5 transition-all shadow-xl shadow-slate-200 h-[46px]"
            >
        ...
        {queryData.length > 0 && (
          <div className="bg-white rounded-[2rem] border border-slate-100 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] overflow-hidden animate-in fade-in slide-in-from-top-4 duration-500">
            ...
            <div className="p-4 bg-slate-50/30 border-t border-slate-50 text-center">
                <p className="text-[9px] font-black text-slate-300 capitalize tracking-widest italic">End of query results</p>
            </div>
          </div>
        )}
      </div>
