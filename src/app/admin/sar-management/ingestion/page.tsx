        ...
        <div className="modern-card p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="relative group">
                    <select value={formData.hostgroup} onChange={(e) => setFormData({ ...formData, hostgroup: e.target.value, hostname: '' })} className="w-full bg-background/50 border border-border rounded-xl py-4 px-5 text-xs capitalize tracking-tight text-slate-700 outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 focus:bg-card transition-all appearance-none cursor-pointer shadow-inner">
                ...
                <div className="relative group">
                    <select value={formData.hostname} onChange={(e) => setFormData({ ...formData, hostname: e.target.value })} className="w-full bg-background/50 border border-border rounded-xl py-4 px-5 text-xs capitalize tracking-tight text-slate-700 outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 focus:bg-card transition-all appearance-none cursor-pointer shadow-inner">
                ...
                <div className="relative group">
                    <select value={formData.dataType} onChange={(e) => setFormData({ ...formData, dataType: e.target.value })} className="w-full bg-background/50 border border-border rounded-xl py-4 px-5 text-xs capitalize tracking-tight text-slate-700 outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 focus:bg-card transition-all appearance-none cursor-pointer shadow-inner">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 p-6 bg-background/50 rounded-[2rem] border border-border shadow-inner flex flex-col justify-center min-h-[180px]">
                ...
                {formData.mode === 'specific' && (
                    <div className="space-y-1 animate-in fade-in zoom-in duration-300">
                        <label className="text-[9px] text-muted-foreground capitalize ml-1">Target Date</label>
                        <input type="date" value={formData.date} onChange={(e) => setFormData({ ...formData, date: e.target.value })} className="w-full bg-card border border-border rounded-xl py-3 px-4 text-xs outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 shadow-sm transition-all" />
                    </div>
                )}
                {formData.mode === 'month' && (
                    <div className="grid grid-cols-2 gap-3 animate-in fade-in zoom-in duration-300">
                        <div className="space-y-1">
                            ...
                            <select value={formData.month} onChange={(e) => setFormData({ ...formData, month: e.target.value })} className="w-full bg-card border border-border rounded-xl py-3 px-2 text-xs outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 shadow-sm transition-all text-center appearance-none">
                                <option value="">Select</option>
                                {months.map(m => <option key={m} value={m}>{m}</option>)}
                            </select>
                        </div>
                        <div className="space-y-1">
                            <label className="text-[9px] text-muted-foreground capitalize ml-1">Year</label>
                            <select value={formData.year} onChange={(e) => setFormData({ ...formData, year: e.target.value })} className="w-full bg-card border border-border rounded-xl py-3 px-2 text-xs outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-200 shadow-sm transition-all text-center appearance-none">
